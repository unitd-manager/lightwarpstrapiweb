    ...
    <PageShell>
      <section className="relative min-h-[75vh] overflow-hidden bg-[#05050d] text-white">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:py-28">
          <div className="grid gap-12 lg:grid-cols-[minmax(440px,0.9fr)_1fr] items-center">
            <motion.div
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="space-y-8 lg:text-right lg:ml-auto"
            >
              <div className="space-y-6 max-w-3xl lg:ml-auto lg:text-right">
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-semibold leading-tight tracking-[-0.03em]">
                  The Jab
                </h1>
                <p className="text-2xl text-white max-w-2xl lg:ml-auto lg:text-right">
                  Lighting, Rendering, Compositing, Final Layout
                </p>
                <p className="text-xl text-white/70 max-w-2xl lg:ml-auto lg:text-right">
              ...
              <div className="space-y-6 max-w-2xl lg:ml-auto lg:text-right">
                <p className="text-lg leading-8 text-white/75 lg:text-right">
